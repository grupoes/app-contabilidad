...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jul 2024 16:58:32 GMT -->
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex border-end bg-transparent">
                    ...
                    <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent bg-none">
                        <div class="card-body">
                            <img src="assets/images/auth/auth.png" class="img-fluid auth-img-cover-login" width="650" alt="">
                        </div>
                    </div>
                ...
                <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center border-top border-4 border-primary border-gradient-1">
                    <div class="card rounded-0 m-3 mb-0 border-0 shadow-none bg-none">
                        <div class="card-body p-sm-5">
                            <img src="assets/images/auth/auth_logo_light.png" class="mb-4" width="245" alt="">
                            <h4 class="fw-bold">Accede</h4>
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jul 2024 16:58:34 GMT -->

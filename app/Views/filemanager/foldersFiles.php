...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end"> <a class="dropdown-item" href="javascript:;" id="folderNew">Carpeta Nueva</a>
        ...
        <div class="modal-content">
            ...
            <form id="formNewFolder">
                ...
                <div class="modal-footer border-top-0">
                    ...
                    <button type="submit" class="btn btn-info" id="btnCreateFolder">Crear</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formUploadFile" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input type="file" id="fileFolder" name="fileFolder[]" class="form-control" multiple>
                </div>
                <div class="modal-footer border-top-0">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
